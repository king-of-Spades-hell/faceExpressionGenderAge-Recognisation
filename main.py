...
age_model = load_model('models/age_model.h5',compile=False)
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        resized_roi = cv2.resize(roi_color, (244, 244))
        # Normalize pixel values
        resized_roi = resized_roi / 255.0
        gender_predict = gender_model.predict(np.array(resized_roi).reshape(-1,244,244,3))
